print("Machine Learning Model Execution Started...")
...
print("/n----- MULTIPLE RANDOM FOREST -----")
...
print("/n----- REGULARIZATION MODEL SCORES (R2) -----")
