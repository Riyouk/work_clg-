...
#load data 
df = pd.read_csv("C:/Users/User/forgit uknow/work_clg-/44/pandas aiml/DataSets/DataSets/amazon_alexa.tsv",delimiter="\t")
print(df.head())
...
df["cleaned_reviews"] = df["verified_reviews"].apply(preprocess_reviews)
print(df[["verified_reviews","cleaned_reviews"]].head(10))
