...
#model 
x_train,x_test = train_test_split(df,test_size=0.30,random_state=42,stratify=df['diagnosis'])
...
grid_lr = GridSearchCV(model,param_grid=param_grid_lr,cv=5,scoring="accuracy",n_jobs=-1)
grid_lr.fit(x_train[x],x_train[y])
print("best logestic REgression params : ",grid_lr.best_params_)
